...
const Loader = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        lineNumber: 149,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0)); // --- MAIN PAGE ---
 ...
 //                                     return <div ref={lastElementRef} key={item.id} className="h-full"><HighlightCard item={item} /></div>;
 //                                 } else {
 //                                     return <div key={item.id} className="h-full"><HighlightCard item={item} /></div>;
 //                                 }
 //                             })}
 //
 //                             {filteredHighlights.length === 0 && !loading && (
 //                                 <div className="col-span-full py-16 text-center text-gray-500 bg-white rounded-xl shadow-sm border border-gray-100">
...
//# sourceMappingURL=_e832d8bd._.js.map