...
import { Search, ChevronRight, RefreshCcw } from "lucide-react";
...
export default function HighlightPage() {
    ...
    const [visibleCount, setVisibleCount] = useState(6); // Start showing 6 items
    ...
    const currentVisibleHighlights = filteredHighlights.slice(0, visibleCount);
    ...
    if (isHighlightError || isBannerError || isCategoriesError) return <div className="w-full h-[200px] md:h-[400px] bg-gray-100 animate-pulse rounded-xl my-6 flex items-center justify-center text-red-500">Error</div>;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 w-full">
                    ...
                    <div className={showRightSidebar ? "lg:col-span-8" : "lg:col-span-10"}>
                        ...
                        <div className={showRightSidebar ? "grid grid-cols-1 sm:grid-cols-2 gap-6" : "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6"}>
                            {currentVisibleHighlights.length > 0 ? (
                                currentVisibleHighlights.map((item: Highlight) => (
